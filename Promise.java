...
public class Promise<T> {
    ...
    public static Promise<ArrayList<Result<?>>> allSettled(ArrayList<Promise<?>> promises) {
        CompletableFuture<?>[] futures = promises.stream().map(promise -> promise.future).toArray(CompletableFuture[]::new);
    ...
    public static Promise<Object> any(ArrayList<Promise<?>> promises) {
        return Promise.create(() -> {
    ...
    public static Promise<Object> race(ArrayList<Promise<?>> promises) {
